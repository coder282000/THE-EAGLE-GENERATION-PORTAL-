...
export default function NewLessonError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <MemberLayout>
      <div className="max-w-2xl mx-auto flex flex-col items-center justify-center py-12 text-center">
        <span className="text-4xl mb-4">⚠️</span>
        <p className="text-lg text-ink-600">Something went wrong loading the lesson editor.</p>
